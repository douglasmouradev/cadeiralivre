        ...
        <div class="auth-page">
            <div class="auth-card auth-card--login">
                <div class="auth-brand">
                    <img src="/assets/img/cadeiralivre-logo.png" width="120" height="120" alt="<?= e(app_name()) ?>">
                </div>
                <h1>Entrar</h1>
                ...
                <p class="muted mt-1 auth-card__links"><a href="/esqueci-senha">Esqueci a senha</a> · <a href="/cadastro">Criar loja</a></p>
            </div>
        </div>
