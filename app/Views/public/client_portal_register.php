...
<main class="public-centered booking-premium__main">
    ...
    <div class="auth-card">
        <h2 class="mt-0" style="font-family:var(--cl-font-serif,'DM Serif Display',Georgia,serif);font-weight:400;font-size:1.35rem">Criar conta de cliente</h2>
        <p class="muted">Crie sua conta para agendar. Não enviamos e-mail de confirmação; você já pode marcar o horário em seguida.</p>
